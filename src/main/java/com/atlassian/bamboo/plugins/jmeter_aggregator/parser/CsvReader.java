...
/**
 * Modified by James Roper, changed the class name from CSVReader to CsvReader, and changed the package from
 * au.com.bytecode.opencsv to com.atlassian.bamboo.plugins.jmeter_aggregator.parser
 */
